...
(country, sex, age-band) combination and, conversely, can recover that metadata
from a filename — which keeps the rest of the pipeline declarative.
"""
...
def parse_filename(filename: str) -> dict:
    ...
    a deliberate guard so silently-mislabelled files never enter the table.
    """
